...
urlpatterns = [
    ...
    re_path(
        r'^remote/add$',
        RemoteRepositoryCreateView.as_view(),
        name='add_remote_repo'),
    re_path(
        r'^remote/(?P<remote_repo_id>[0-9]+)/update/$',
        views.remote_update,
        name='remote_update'),

    # App
    re_path(
        r'^(?P<repo_id>[0-9]+)/app/add/$',
        AppRemoteAddView.as_view(),
        name='add_app'),
    ...
    # App Detail and Edit
    re_path(
        r'^(?P<repo_id>[0-9]+)/app/(?P<app_id>[0-9]+)/$',
    ...
    # Apks
    re_path(r'^(?P<repo_id>[0-9]+)/app/apk/upload/$',
            ApkUploadView.as_view(), name='apk_upload'),
